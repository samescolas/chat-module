...
*
*********************************************************************/
#ifndef DOG_OSS_CHAR_H
#define DOG_OSS_CHAR_H
...
#define DOG_IOCTL_MAGIC 208 // picking 0xd0 

// base sequence number
#define DOG_IOCTL_BASE_SEQ 0 

// read from kernel sequence number is base + 1
#define DOG_IOCTL_RFK (DOG_IOCTL_BASE_SEQ + 1)

// write to kernel sequence number is base + 2
#define DOG_IOCTL_WTK (DOG_IOCTL_BASE_SEQ + 2)

//
// _IOR() creates an IOCTL that is reading from the kernel
//        DOG_IOCTL_MAGIC is the magic byte
//        
// The last argument might be better suited as a structure!
// 
#define IOCTL_READ_FROM_KERNEL _IOR(DOG_IOCTL_MAGIC, DOG_IOCTL_RFK, char *)

#define IOCTL_WRITE_TO_KERNEL _IOWR(DOG_IOCTL_MAGIC, DOG_IOCTL_WTK, char *)


#endif // DOG_OSS_CHAR_H
