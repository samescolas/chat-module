...
static int __init secret412amodule_init(void)
{
...
static void __exit secret412amodule_exit(void)
{
...
module_init(secret412amodule_init);
module_exit(secret412amodule_exit);
